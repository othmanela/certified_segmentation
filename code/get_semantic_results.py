...
dirs = filter(lambda x: x.startswith("pascal_ctx_0.25_XXXXX"), dirs)
...
print(df.groupby(['scale', 'flip', 'batch_size','model', 'correction', 'n0', 'tau', 'N', 'alpha', 'sigma'])['accuracy','mean iou','abstain','time'].mean())
print(df.groupby(['correction'])['accuracy','mean iou','abstain','time'].mean())
